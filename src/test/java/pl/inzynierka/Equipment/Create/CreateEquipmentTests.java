package pl.inzynierka.Equipment.Create;
...
public class CreateEquipmentTests {
    ...
    public void test_createEquipment_should_create_success() throws Exception{
        ...
        mockMvc.perform(
                post("/equipments/create")
                        ...
                        .flashAttr("equipment", addEquipmentCommand))
                .andDo(print())
    ...
    @Test
    @WithMockUser(roles = {"REPAIRMAN", "ADMIN"})
    public void createEquipmentFail() throws Exception{

        AddEquipmentCommand addEquipmentCommand = new AddEquipmentCommand("title", image, "", 50, LocalDate.now(), 10, "description", "serialNumber", LocalDate.now().minusDays(30L));
