package pl.inzynierka.Equipment.Retrive;
...
@SpringBootTest
public class RetriveEquipmentTests {
    ...
    public void getEquipmentSuccess() throws Exception{
        ...
        mockMvc.perform(
                ...
                .andExpect(view().name("/equipment/selected"));
    ...
    @Test
    @WithMockUser(roles = {"REPAIRMAN", "ADMIN"})
    public void getEquipmentFail() throws Exception{
