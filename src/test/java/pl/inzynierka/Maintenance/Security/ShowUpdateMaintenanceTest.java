...
@SpringBootTest
public class ShowUpdateMaintenanceTest {
    ...
    public void testShowCreateMaintenanceFormAuthorizationForRepairmanSuccess() throws Exception {

        mockMvc.perform(
                get("/maintenances/1/update"))
                .andDo(print())
    ...
    public void testShowCreateMaintenanceFormAuthorizationForAdminSuccess() throws Exception {
    ...
    public void testShowCreateMaintenanceFormAuthorizationForClientSuccess() throws Exception {
    ...
    @Test
    public void testShowCreateMaintenanceFormAuthorizationForGuestSuccess() throws Exception {
