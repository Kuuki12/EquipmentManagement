...
@SpringBootTest
public class DeleteMaintenanceTest {
    ...
    public void testDeleteMaintenanceAuthorizationForRepairmanSuccess() throws Exception {
    ...
    public void testDeleteMaintenanceAuthorizationForAdminSuccess() throws Exception {
    ...
    public void testDeleteMaintenanceAuthorizationForClientSuccess() throws Exception {
    ...
    @Test
    public void testDeleteMaintenanceAuthorizationForGuestSuccess() throws Exception {
