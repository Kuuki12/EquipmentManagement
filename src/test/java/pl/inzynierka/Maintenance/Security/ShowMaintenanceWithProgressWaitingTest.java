...
@SpringBootTest
public class ShowMaintenanceWithProgressWaitingTest {
    ...
    public void test_ShowMaintenanceWithProgressWaiting_ReturnAuthorizationForRepairman_Success() throws Exception {

        mockMvc.perform(
                get("/maintenances/1/waiting"))
                .andDo(print())
    ...
    public void test_ShowMaintenanceWithProgressWaiting_ReturnAuthorizationForAdmin_Success() throws Exception {
    ...
    public void test_ShowMaintenanceWithProgressWaiting_ReturnAuthorizationForClient_Success() throws Exception {
    ...
    @Test
    public void test_ShowMaintenanceWithProgressWaiting_ReturnAuthorizationForGuest_Success() throws Exception {
