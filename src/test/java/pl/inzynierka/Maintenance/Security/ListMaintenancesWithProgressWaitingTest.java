...
@SpringBootTest
public class ListMaintenancesWithProgressWaitingTest {
    ...
    public void test_ListMaintenancesWithProgressWaiting_ReturnAuthorizationForRepairman_Success() throws Exception {

        mockMvc.perform(
                get("/maintenances/waiting"))
                .andDo(print())
    ...
    public void test_ListMaintenancesWithProgressWaiting_ReturnAuthorizationForAdmin_Success() throws Exception {
    ...
    public void test_ListMaintenancesWithProgressWaiting_ReturnAuthorizationForClient_Success() throws Exception {
    ...
    @Test
    public void test_ListMaintenancesWithProgressWaiting_ReturnAuthorizationForGuest_Success() throws Exception {
