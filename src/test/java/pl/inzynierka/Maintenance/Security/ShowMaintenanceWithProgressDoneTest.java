...
@SpringBootTest
public class ShowMaintenanceWithProgressDoneTest {
    ...
    public void test_ShowMaintenanceWithProgressDone_ReturnAuthorizationForRepairman_Success() throws Exception {

        mockMvc.perform(
                get("/maintenances/1/done"))
                .andDo(print())
    ...
    public void test_ShowMaintenanceWithProgressDone_ReturnAuthorizationForAdmin_Success() throws Exception {
    ...
    public void test_ShowMaintenanceWithProgressDone_ReturnAuthorizationForClient_Success() throws Exception {
    ...
    @Test
    public void test_ShowMaintenanceWithProgressDone_ReturnAuthorizationForGuest_Success() throws Exception {
