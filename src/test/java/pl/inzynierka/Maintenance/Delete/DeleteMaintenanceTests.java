package pl.inzynierka.Maintenance.Delete;
...
@SpringBootTest
public class DeleteMaintenanceTests {
    ...
    public void deleteMaintenanceFail() throws Exception{

        when(maintenanceRepository.findOne(1L)).thenReturn(null);

        mockMvc.perform(
                delete("/maintenances/{id}", 1L))
                .andDo(print())
                .andExpect(status().isNotFound());

        verify(maintenanceRepository, times(1)).findOne(1L);
