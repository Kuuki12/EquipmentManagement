package pl.inzynierka.Maintenance.Create;
...
@SpringBootTest
public class CreateMaintenanceTests {
    ...
    public void createMaintenanceSuccess() throws Exception{

        AddMaintenanceCommand addMaintenanceCommand = new AddMaintenanceCommand("name", 1L, LocalDate.now());

        mockMvc.perform(
                post("/maintenances/create")
                        .contentType(MediaType.APPLICATION_JSON)
                        .flashAttr("maintenance", addMaintenanceCommand))
                .andDo(print())
    ...
    @Test
    @WithMockUser(roles = {"REPAIRMAN", "ADMIN"})
    public void createMaintenanceFail() throws Exception{

        AddMaintenanceCommand addMaintenanceCommand = new AddMaintenanceCommand("", 1L, LocalDate.now());
