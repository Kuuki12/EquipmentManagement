...
@SpringBootTest
public class ShowUpdateReportTest {
    ...
    public void test_ShowUpdateReportForm_AuthorizationForRepairman_Success() throws Exception {

        mockMvc.perform(
                get("/maintenances/1/reports/1/update"))
                .andDo(print())
    ...
    public void test_ShowUpdateReportForm_AuthorizationForAdmin_Success() throws Exception {
    ...
    public void test_ShowUpdateReportForm_AuthorizationForClient_Success() throws Exception {
    ...
    @Test
    public void test_ShowUpdateReportForm_AuthorizationForGuest_Success() throws Exception {
