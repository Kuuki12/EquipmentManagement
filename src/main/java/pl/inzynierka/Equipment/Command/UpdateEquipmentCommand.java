...
public class UpdateEquipmentCommand {
    ...
    @NotFileConstraint
    @ContentTypeConstraint(value = {"image/png", "image/jpeg"}, message = "Dozwolone tylko rozszerzenia .png i .jpg")
    private MultipartFile image;
    @NotEmpty private String emailOwner;
    ...
    public UpdateEquipmentCommand(String name, MultipartFile image, String emailOwner, Integer priority, LocalDate lastMaintenanceDate, Integer maintenanceFrequency, String description, String serialNumber, LocalDate productionDate) {
        this.name = name;
        this.image = image;
